...
export default function RemixIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      ...
      <g fill="none">
        ...
        <path
          ...
          strokeOpacity={0.8}
          strokeWidth={0.32}
          d="M62 203.36v.16h51.801v-15.202c0-1.602-.392-3.755-1.701-5.512c-1.314-1.765-3.539-3.109-7.157-3.109H62v.16z"
        ></path>
      </g>
    </svg>
  );
